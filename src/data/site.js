...
export const site = {
  ...
  socials: [
    ...
    { label: 'LinkedIn', url: 'https://www.linkedin.com/in/mubarak-olanrewaju/', icon: 'linkedin' },
...
export const skillGroups = [
  {
    ...
    chips: ['React', 'Angular', 'JavaScript', 'TypeScript', 'CSS Modules', 'Sass', 'Angular Material', 'Responsive UI'],
  },
  {
    icon: 'plug',
    ...
    chips: ['REST APIs', 'WebSockets', 'Auth & role-based access', 'FHIR-aligned health data', 'Web3 SDKs (Hedera · Solana · IOTA)'],
  },
  {
    icon: 'users',
    ...
    chips: ['Team Lead', 'Mentoring', 'UI/UX Wireframing', 'WordPress & SEO', 'Shipping & maintaining live products'],
  },
]
