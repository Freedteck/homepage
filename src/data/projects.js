...
export const projects = [
  ...
  /* ---------------------------------------------------------- */
  {
    ...
    coverAlt:
      "Two apps, one record: the Kostody engineer and customer apps side by side",
    blurb:
    ...
    links: [
      { label: "kostody.vercel.app", url: "https://kostody.vercel.app/" },
    ],
    intro: [
    ...
    gallery: [
      {
        src: "/images/projects/kostody/jobs.webp",
        caption:
          "The engineer\u2019s Active Jobs board: checked in, charted, discharged",
      },
      {
        src: "/images/projects/kostody/record.webp",
        caption: "The customer\u2019s live repair record",
      },
      {
        src: "/images/projects/kostody/pin.webp",
        caption:
          "One number, every shop: nothing moves without the customer\u2019s PIN",
      },
      {
        src: "/images/projects/kostody/values-light.webp",
        caption:
          "What we stand for: four convictions, each one a line in the product",
      },
      {
        src: "/images/projects/kostody/mobile.webp",
        caption: "The marketing site on a phone",
      },
    ],
  },
  ...
  /* ---------------------------------------------------------- */
  {
    ...
    coverAlt:
      "LevelUp student dashboard with XP progress, level and enrolled courses",
    blurb:
    ...
    links: [
      {
        label: "levelup-curriculum.netlify.app",
        url: "https://levelup-curriculum.netlify.app/",
      },
    ],
    intro: [
    ...
    gallery: [
      {
        ...
        caption:
          "The personalized catalog: AI-generated courses, searchable and filtered",
      },
      {
        src: "/images/projects/levelup/course-detail.webp",
        caption:
          "Inside a generated course: modules, lessons and completion at a glance",
      },
      {
        src: "/images/projects/levelup/lesson.webp",
        caption:
          "The lesson viewer: rich content, code examples and curated resources",
      },
      {
        src: "/images/projects/levelup/profile.webp",
        caption:
          "The learning profile: the four answers that drive every generation",
      },
      {
  ...
  /* ---------------------------------------------------------- */
  {
    ...
    coverAlt:
      "Abstract illustration standing in for the NDIC BLMS product, which is not public (NDA)",
    blurb:
      "A bank liquidation management system for Nigeria\u2019s deposit insurer, built on an enterprise Angular team.",
  ...
  /* ---------------------------------------------------------- */
  {
    ...
    cover: "/images/projects/enterprise.webp",
    coverAlt:
      "Abstract illustration standing in for the NSIA procurement product, which is not public (NDA)",
    blurb:
      "The procurement management system of the Nigeria Sovereign Investment Authority, maintained and evolved in production.",
    stack: ["Angular", "Angular Material", "Sass"],
    links: [],
    intro: [
  ...
  /* ---------------------------------------------------------- */
  {
    ...
    cover: "/images/projects/enterprise.webp",
    coverAlt:
      "Abstract illustration standing in for the NAQS aquatic product, which is not public (NDA)",
    blurb:
      "An aquatic resource management system for a federal quarantine service, evolved feature by feature in production.",
    stack: ["Angular", "Angular Material", "Sass"],
    links: [],
    intro: [
